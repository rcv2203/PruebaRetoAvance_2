...
public class EnergiaRenovable extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_energia_renovable, container, false);

        Button btnEnergiaRenovable = view.findViewById(R.id.btn_tip_energia_renovable_M_O);
        textView = view.findViewById(R.id.fragmen_energia_renovable);
