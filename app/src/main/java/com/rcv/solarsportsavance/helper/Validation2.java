package com.rcv.solarsportsavance.helper;

import android.view.View;
import android.widget.EditText;
import android.widget.TextView;

import com.rcv.solarsportsavance.RegisterActivity;
...
public class Validation2 {
    ...
    public void validateTextField(EditText editText, String fieldName, int min, int max, RegisterActivity.TipoCampo tipoCampo) {

        String text = editText.getText().toString();
        String msg = "";

        if (tipoCampo == RegisterActivity.TipoCampo.REQUERIDO && text.isEmpty()) {
            msg = "El campo " + fieldName + " no puede estar vacío";
            errorMessages.add(msg);
            //Log.e("ERROR", "El campo " + fieldName + " no puede estar vacío");
            return;
        }
    ...
    public void validateNumber(EditText editText, String nombreCampo, int min, int max, RegisterActivity.TipoCampo tipoCampo){

        String texto = editText.getText().toString();

        if(tipoCampo == RegisterActivity.TipoCampo.REQUERIDO && texto.isEmpty()){
